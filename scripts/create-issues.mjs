...
if (!TOKEN) {
  console.error(
    '❌ GITHUB_TOKEN manquant. Exporte-le avant de lancer le script.',
  )
  process.exit(1)
}
...
function buildIssues(milestones) {
  ...
  if (!ms1 || !ms2 || !ms3 || !ms4 || !ms5) {
    console.warn(
      "⚠️  Certains milestones n'ont pas été trouvés. Milestones disponibles :",
      milestones,
    )
    console.warn(
    ...
    console.log(
      `✅ Milestones résolus : ms1=${ms1} ms2=${ms2} ms3=${ms3} ms4=${ms4} ms5=${ms5}`,
    )
  }
  ...
  return [
    ...
    },
    {
      ...
      body: userStoryBody({
        asA: 'utilisateur connecté',
        iWant: "consulter l'agenda de l'IUT en vue mensuelle et hebdomadaire",
        soThat:
